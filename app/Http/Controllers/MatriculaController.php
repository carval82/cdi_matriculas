...
class MatriculaController extends Controller
{
    ...
    {
        $query = Matricula::with(['estudiante', 'estancia', 'acudiente']);
        ...
        return view('matriculas.index', compact('matriculas', 'estancias', 'anios'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('matriculas.create', compact('estancias', 'estudiantes', 'acudientes', 'estudiantePreseleccionado'));
    }
    ...
    {
        $matricula->load(['estudiante.acudiente', 'estancia', 'acudiente', 'pagos']);
    ...
    public function edit(Matricula $matricula)
    {
        ...
        return view('matriculas.edit', compact('matricula', 'estancias', 'acudientes'));
    }
    ...
    public function update(Request $request, Matricula $matricula)
    {
        ...
        if ($matricula->estado === 'activa') {
            $matricula->estudiante->update(['estancia_id' => $request->estancia_id]);
        }
