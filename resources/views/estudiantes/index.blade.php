<x-app-layout>
    ...
    <div>
        <div class="flex justify-between items-center mb-5">
            <div></div>
            <a href="{{ route('estudiantes.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 rounded-lg font-semibold text-sm text-white hover:bg-blue-700 transition shadow-sm">
